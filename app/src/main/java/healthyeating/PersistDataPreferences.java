...
public class PersistDataPreferences {
    ...
    public void writeToFile(String data,Context context, String outputFile) {
        try {
    ...
    public String readFromFile(Context context, String outputFile) {
        String ret = "";

        try {
            InputStream inputStream = context.openFileInput(outputFile);
